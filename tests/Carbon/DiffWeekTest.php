...

{
    public function testDiffWeekTest()
    {
        ...
        $dtOne = Carbon::createFromDate(2020, 1, 14);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        ...
        $dtOne = Carbon::createFromDate(2020, 1, 15);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        $this->assertSame($dtOne->diffInSpanWeeks($dtTwo), 3);
        ...
        $dtOne = Carbon::createFromDate(2020, 1, 15);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        $this->assertSame($dtOne->diffInSpanWeeks($dtTwo, 3), 4);
        ...
        $dtOne = Carbon::createFromDate(2020, 1, 13);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        $this->assertSame($dtOne->diffInSpanWeeks($dtTwo), 3);

        $dtOne = Carbon::createFromDate(2020, 1, 13);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        $this->assertSame($dtOne->diffInSpanWeeks($dtTwo, 2), 2);
        ...
        $dtOne = Carbon::createFromDate(2020, 1, 12);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        ...
        $dtOne = Carbon::createFromDate(2020, 1, 11);
        $dtTwo = Carbon::createFromDate(2019, 12, 31);
        $this->assertSame($dtOne->diffInSpanWeeks($dtTwo), 2);
